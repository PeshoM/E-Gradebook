    ...
    : db(database), scroll_offset(0.f), show_modal(false), input_active(false), editing_student_id(-1), show_error(false)
{
    ...
    input_box_number.setFillColor(sf::Color(90, 90, 160));
    input_box_name.setFillColor(sf::Color(90, 90, 160));
    input_box_date.setFillColor(sf::Color(90, 90, 160));
    ...
    input_text_number.setFillColor(sf::Color(220, 220, 255));
    input_text_name.setFillColor(sf::Color(220, 220, 255));
    input_text_date.setFillColor(sf::Color(220, 220, 255));
